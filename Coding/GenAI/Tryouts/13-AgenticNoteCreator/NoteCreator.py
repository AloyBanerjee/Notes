...
#https://serpapi.com/users/welcome(https://serpapi.com/dashboard)
#https://app.composio.dev/dashboard
...
if st.button("Start"):
    if not st.session_state['topic']:
        ...
        pprint_run_response(professor_response.content, markdown=True)
        st.divider()
        
        st.markdown("### Academic Advisor Response:")
        st.markdown(academic_advisor_response.content)
        pprint_run_response(academic_advisor_response.content, markdown=True)
        st.divider()

        st.markdown("### Research Librarian Response:")
        st.markdown(research_librarian_response.content)
        pprint_run_response(research_librarian_response.content, markdown=True)
        st.divider()

        st.markdown("### Teaching Assistant Response:")
        st.markdown(teaching_assistant_response.content)
        pprint_run_response(teaching_assistant_response.content, markdown=True)
        st.divider()
