...
def main():
    ...
    st.markdown("""
    # Reasoning Chatbot powered by <img src="data:image/png;base64,{}" width="170" style="vertical-align: -3px;">
""".format(base64.b64encode(open("assets/deep-seek.png", "rb").read()).decode()), unsafe_allow_html=True)
    st.markdown("<h4 style='text-align: left;'>Think Smart!!! 💡</h4>", unsafe_allow_html=True)
